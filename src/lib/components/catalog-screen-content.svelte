  ...
  >
    <div class="catalog-tile-grid grid grid-cols-1">
      ...
      <CatalogTile
        ...
        description="Essay · General Studies · Mathematics"
...
{:else if screen.kind === "mains"}
  ...
  >
    {#each MAINS_PAPER_TYPES as paper, index (paper.id)}
      <CatalogTile
        title={paper.label}
...
{:else if screen.kind === "prelims-paper"}
  {#if prelimsPapers.length === 0}
    <div class="catalog-grid-start mx-auto w-full max-w-5xl text-center">
